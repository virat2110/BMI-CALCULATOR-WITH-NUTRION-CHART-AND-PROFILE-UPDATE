    ...
    <form action="RegisterData" method="get">
     <%
        ...
        <input type="text" name="t3"  class="email"  placeholder ="email" required/>
         <input type="password" name="t4"  class="email"  placeholder ="password" required/>
         <input type="password" name="t5"  class="email"  placeholder ="re-type password" required/>
         <input type="number" name="t6"  class="email"  placeholder ="encryption-key(donot forget)" required/>
